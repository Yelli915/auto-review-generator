...
사진 최대 3장과 리뷰 분야, 별점, 선택한 키워드를 바탕으로 한국어 리뷰 초안을 생성하는 React + Gemini 웹 애플리케이션입니다.
...
- 이미지 최대 3장 업로드, 리뷰 분야 선택, 별점 선택, 키워드 생성, 리뷰 생성, 클립보드 복사
...
- 선택한 분야, 키워드, 별점, 리뷰 길이, 말투 옵션을 기반으로 리뷰를 생성합니다.
