...
function buildSubjectiveReviewGuide(category) {
  return category === 'place'
    ? '리뷰는 객관 설명문이 아니라 실제 방문자가 직접 다녀온 뒤 남기는 주관적 후기처럼 써. "제가", "저는", "직접 가보니", "느꼈어요"처럼 자연스러운 1인칭 경험 표현을 섞고, 공간을 이용하며 편했던 점, 아쉬웠던 점, 다시 방문할 때 고려할 점처럼 체감 중심으로 풀어.'
    : '리뷰는 객관 설명문이 아니라 실제 사용자가 직접 써보고 남기는 주관적 후기처럼 써. "제가", "저는", "직접 써보니", "느꼈어요"처럼 자연스러운 1인칭 경험 표현을 섞고, 사용하면서 좋았던 점과 아쉬웠던 점, 내 기준에서 만족한 이유를 체감 중심으로 풀어.'
}
...
function buildCosmeticEvaluationGuide(category) {
  return category === 'product'
    ? '상품이 화장품이나 뷰티 제품으로 보이면 향, 발림성, 흡수력, 보습감, 밀착감, 끈적임, 마무리감, 지속력, 피부 자극 여부, 피부 타입과의 궁합처럼 화장품 리뷰에 맞는 체감 항목을 우선 반영해. 피부에 닿았을 때 건조함 완화, 촉촉함, 산뜻함, 답답함 감소, 유분감 조절, 들뜸 완화처럼 사용자가 바로 느낄 수 있는 피부 체감 효과는 반영하되, 사진이나 키워드에서 확인되지 않은 성분 효과, 의학적 효능, 장기간 변화는 만들지 마.'
    : ''
}

function buildCosmeticKeywordContentsGuide(category) {
  return category === 'product'
    ? '화장품이나 뷰티 제품의 키워드를 만들 때는 병, 튜브, 펌프, 캡, 케이스, 패키지 같은 용기 표현을 키워드의 중심으로 쓰지 말고, 내용물의 제형, 색감, 광택, 농도, 향, 발림성, 흡수감, 보습감, 밀착감, 마무리감을 우선 키워드로 뽑아. 가능하면 피부에 어떤 체감 효과를 주는지도 생각해 촉촉한 피부감, 건조함 완화, 산뜻한 마무리, 유분감 덜함, 답답함 적음, 들뜸 완화처럼 사용 직후 느낄 수 있는 피부 반응 중심 키워드로 만들어. 미백, 주름 개선, 여드름 치료, 피부 장벽 회복처럼 사진이나 상품 정보만으로 확인하기 어려운 기능성·의학적·장기 효과는 추측하지 마. 용기 관련 키워드는 누수, 파손, 펌프 불량, 위생, 휴대성처럼 실제 사용 판단에 직접 영향을 주는 경우에만 예외적으로 써.'
    : ''
}
