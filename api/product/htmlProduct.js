...
import { decodeHtmlEntities, extractMetaContent, extractTitle, parseAttributes } from './htmlUtils.js'
import {
  buildProductInfo,
  firstImageValue,
  firstString,
...
// -- Embedded JSON (inline script payload) extraction --
...
// -- HTML metadata extraction (orchestrates the strategies above) --
